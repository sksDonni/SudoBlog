  ...
  if(posts !== null)
  {
    ...
    return(
      <div className="w-1/2 m-auto">
        <h1 className="text-2xl font-semibold text-center border-b-2 border-black">{subgroupName.toUpperCase()}</h1>
          {Postlist}
      </div>
      )    
  }else{
    return <div className="text-2xl font-semibold text-center border-b-2 border-black">Loading...</div>
  }
